...
Процедура ВыполнитьТесты(ИмяБиблиотеки)
    ...
    ПодключитьСценарий("./../Example/Forms/Autotests/Ext/Form/Module.bsl", "Автотесты");
    ПодключитьСценарий("./../Example/Forms/xUnitBDD/Ext/Form/Module.bsl", "xUnitBDD");
