...
Процедура MakePackage()
	...
	Для НомерСтроки = 1 По 4 Цикл 
		...
		Если СтрНайти(Стр, "VERSION_FULL") > 0 Тогда
			...
			СуффиксВерсии = СтрЗаменить(Стр, ".", "_");
			Прервать;
		КонецЕсли;
	КонецЦикла;
	...
	ДобавитьЭлемент("Windows" , "i386"   , "bin/Release/libVanessaExtWin32.dll");
	ДобавитьЭлемент("Windows" , "x86_64" , "bin/Release/libVanessaExtWin64.dll");
