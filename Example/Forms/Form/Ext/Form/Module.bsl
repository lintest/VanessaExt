...
Процедура НайтиФрагментКартинки() Экспорт
	...
	ВнешняяКомпонента.НачатьВызовНастроитьРисование(Новый ОписаниеОповещения, 255, 2000, 4, 255);
	ВнешняяКомпонента.НачатьВызовНарисоватьПрямоугольник(Новый ОписаниеОповещения, Координаты.Left, Координаты.Top, Координаты.Width, Координаты.Height);

КонецПроцедуры

&НаКлиенте
Процедура УстановитьНастройкиРисования()
	
	ВнешняяКомпонента.НастроитьРисование(ЦветКакЧисло(ЦветФигуры), Таймаут, Толщина, Прозрачность);
...
Процедура ФигураПрямоугольник(Команда)
	...
	УстановитьНастройкиРисования();
	ВнешняяКомпонента.НарисоватьПрямоугольник(ФигураX, ФигураY, ФигураW, ФигураH);
...
Процедура ФигураЭллипс(Команда)
	...
	УстановитьНастройкиРисования();
	ВнешняяКомпонента.НарисоватьЭллипс(ФигураX, ФигураY, ФигураW, ФигураH);
...
Процедура ФигураЗатенение(Команда)
	...
	УстановитьНастройкиРисования();
	ВнешняяКомпонента.НарисоватьТень(ФигураX, ФигураY, ФигураW, ФигураH);
...
Процедура ФигураПрямаяСтрелка(Команда)
	...
	УстановитьНастройкиРисования();
	ВнешняяКомпонента.НарисоватьСтрелку(ФигураX, ФигураY + ФигураH, ФигураX + ФигураW, ФигураY);
...
Процедура ФигураКриваяСтрелка(Команда)
	...
	ВнешняяКомпонента.НарисоватьКривую(ТекстJSON);	
