...
&НаСервере
Перем ВК, ПК, Буф, ГИТ, git;

&НаКлиенте
Процедура ПриОткрытии(Отказ)
	
	Если ПараметрЗапуска = ИмяФайлаОбработки Тогда
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Лог.ЗаписатьСтроку("Автоест: " + ТекущаяУниверсальнаяДата());
	Лог.Закрыть();
...
Процедура ВыполнитьТесты()
	...
	ТестВыполнить(Группа, "Проверка генерации ошибки", "ВК.Проверка = ""Тест""");
