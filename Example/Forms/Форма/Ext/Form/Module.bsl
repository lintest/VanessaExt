...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МестоположениеКомпоненты = "C:\1C\1cWinCtrl\\bind64\lib1cWinCtrlWin64.dll";
...
&НаКлиенте
Процедура НажатиеГорячейКлавиши(Команда)

	ЭмуляцияКлавиши(Новый СочетаниеКлавиш(Клавиша.F11, Ложь, Истина, Ложь));
