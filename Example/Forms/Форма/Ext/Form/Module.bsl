...
Процедура ПолучитьДанныеПроцесса(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПолученыСвойстваПроцесса", ЭтотОбъект);
	ВнешняяКомпонента.НачатьВызовПолучитьСвойстваПроцесса(ОписаниеОповещения, ТекущиеДанные.ProcessId);
	
КонецПроцедуры

&НаКлиенте
Процедура ПолученыСвойстваПроцесса(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
...
Процедура ПолучитьСписокОкон(Команда)
	...
	ВнешняяКомпонента.НачатьВызовПолучитьСписокОкон(ОписаниеОповещения, Неопределено);
...
Процедура Распахнуть(Команда)
	...
	ВнешняяКомпонента.НачатьВызовРаспахнутьОкно(Новый ОписаниеОповещения, ДескрипторОкна, Активировать);
...
Процедура Свернуть(Команда)
	...
	ВнешняяКомпонента.НачатьВызовСвернутьОкно(Новый ОписаниеОповещения, ДескрипторОкна, Активировать);
...
Процедура Развернуть(Команда)
	...
	ВнешняяКомпонента.НачатьВызовРазвернутьОкно(Новый ОписаниеОповещения, ДескрипторОкна, Активировать);
...
Процедура ПолучитьСтатус(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ПолученСтатусОкна", ЭтотОбъект);
	ВнешняяКомпонента.НачатьВызовПолучитьСтатусОкна(ОписаниеОповещения, ДескрипторОкна);
	
КонецПроцедуры

&НаКлиенте
Процедура ПолученСтатусОкна(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	
	СтатусОкна = РезультатВызова;
...
Процедура УстановитьСтатус(Команда)
	...
	ВнешняяКомпонента.НачатьВызовУстановитьСтатусОкна(Новый ОписаниеОповещения, ДескрипторОкна, СтатусОкна, Активировать);
	
КонецПроцедуры

&НаКлиенте
Процедура ПолучитьДочерниеОкна(Команда)
