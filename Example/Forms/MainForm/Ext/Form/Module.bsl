...
Процедура МониторингСобытийНачать(Команда)
	...
	ВнешняяКомпонента.НачатьВызовНачатьМониторингСобытий(Новый ОписаниеОповещения);
...
Процедура МониторингСобытийЗавершить(Команда)
	...
	ВнешняяКомпонента.НачатьВызовПрекратитьМониторингСобытий(Новый ОписаниеОповещения);
