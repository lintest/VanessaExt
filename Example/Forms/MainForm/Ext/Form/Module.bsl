...
&НаСервереБезКонтекста
Функция ПолучитьКартинкуНаСервере(УникальныйИдентификатор, ВысотаКартинки)
	...
	Результат = Новый Структура("АдресКартинки,ШиринаКартинки,ВысотаКартинки", АдресКартинки, ВысотаКартинки, ВысотаКартинки);
	Возврат Результат;
