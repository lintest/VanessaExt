...
Функция Больше(Знач Значение) Экспорт
	...
	Если Не (ПроверяемоеЗначение > Значение) Тогда
		Возврат ЗаписатьПроблему("Проверяемое значение " + Строка(Значение) + " должно быть больше " + Строка(ТекущийШаг.Эталон));
	КонецЕсли;
...
Функция Меньше(Знач Значение) Экспорт
	...
	Если Не (ПроверяемоеЗначение < Значение) Тогда
		Возврат ЗаписатьПроблему("Проверяемое значение " + Строка(Значение) + " должно быть меньше " + Строка(ТекущийШаг.Эталон));
	КонецЕсли;
