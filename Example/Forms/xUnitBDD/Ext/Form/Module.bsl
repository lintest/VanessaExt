...
Функция Больше(Знач Значение) Экспорт
	...
	Если Не (ПроверяемоеЗначение > Значение) Тогда
		Возврат ЗаписатьПроблему("Проверяемое значение " + Строка(Значение) + " должно быть больше " + Строка(Значение));
	КонецЕсли;
...
Функция Меньше(Знач Значение) Экспорт
	...
	Если Не (ПроверяемоеЗначение < Значение) Тогда
		Возврат ЗаписатьПроблему("Проверяемое значение " + Строка(Значение) + " должно быть меньше " + Строка(Значение));
	КонецЕсли;
