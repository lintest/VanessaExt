...
Процедура Тест_УправлениеПриложением(Ожидается) Экспорт
	...
	Для каждого ЭлементКоллекции из ЭлементыИнтерфейса Цикл
		...
		Если ИдКнопки = "103" ИЛИ ИдКнопки = "102" Тогда
		...
		КонецЕсли;
	КонецЦикла;
	Ожидается.Тест().Что(ВК).Получить("ТекстБуфераОбмена").Равно("!");
	...
	Для каждого ЭлементКоллекции из ЭлементыИнтерфейса Цикл
		...
		КонецЕсли;
        КонецЦикла;
	Ожидается.Тест().Что(ВК).Функц("НайтиЭлементы", ИдентификаторПроцесса, ИмяТекста, "Edit").Получить(0, "Value").Сокр().Равно("!");
