...
Процедура Тест_УправлениеПриложением(Ожидается) Экспорт
	...
	Ожидается.Тест().Что(ВК).Функц("НайтиЭлементы", ИдентификаторПроцесса, "", КнопкаЗакрытия.Type).Равно("null");
	Ожидается.Тест().Что(ВК).Функц("НайтиЭлементы", ИдентификаторПроцесса, Неопределено, КнопкаЗакрытия.Type).JSON().Функц("Количество").Больше(1);
	...
	Ожидается.Тест().Что(ВК).Функц("НайтиЭлементы", ИдентификаторПроцесса, ИмяКнопки).Получить(0, "Name").Равно(ИмяКнопки);
	Ожидается.Тест().Что(ВК).Функц("НайтиЭлементы", ИдентификаторРодителя, ИмяКнопки).Получить(0, "Name").Равно(ИмяКнопки);
	Ожидается.Тест().Что(ВК).Функц("НайтиЭлементы", ИдентификаторФормы, ИмяКнопки).Получить(0, "Name").Равно(ИмяКнопки);
