...
Процедура Тест_ПарсерЯзыкаGherkin(Ожидается) Экспорт
	...
	Контекст.Добавить("Сценарий");
	
	РусскиеСлова = Новый Структура("feature,background,scenarios,and", Функционал, Контекст, Сценарий, МассивСлов);
	...
	РусскоеСлово.Добавить("Сценарий");
