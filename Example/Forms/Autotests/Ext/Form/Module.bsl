...
Процедура ЗаполнитьНаборТестов(ЮнитТест) Экспорт
	...
	ЮнитТест.Добавить("Тест_ПарсерЯзыкаGherkin", "Парсер языка Gherkin");
...
&НаКлиенте
Процедура Тест_ПарсерЯзыкаGherkin(Ожидается) Экспорт
	...
	Сценарий.Добавить("Сценарий");
	
	РусскиеСлова = Новый Структура("feature,background,scenario,and", Функционал, Контекст, Сценарий, МассивСлов);
	...
	РусскоеСлово = Новый Массив;
	РусскоеСлово.Добавить("Функционал");
	РусскиеСлова = Новый Структура("feature", РусскоеСлово);

	АнглийскоеСлово = Новый Массив;
	АнглийскоеСлово.Добавить("Feature");
	АнглийскиеСлова = Новый Структура("feature", АнглийскоеСлово);

	КлючевыеСлова = Новый Структура("ru,en", РусскиеСлова, АнглийскиеСлова);
	КлючевыеСлова = ЗаписатьСтрокуJSON(КлючевыеСлова);
