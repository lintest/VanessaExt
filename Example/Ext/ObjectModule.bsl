...
Процедура Тест_ФункционалGit() Экспорт
	...
	Ожидается.Тест("Статус рабочей области").Что(ВК).Функц("status").Результат().Получить("work").Функц("Получить", 0).Получить("new_name").Равно(ИмяФайла);
	Ожидается.Тест("Добавление в индекс").Что(ВК).Функц("add", ИмяФайла).Успешно();
	Ожидается.Тест("Статус после добавления").Что(ВК).Функц("status").Результат().Получить("index").Функц("Получить", 0).Получить("new_name").Равно(ИмяФайла);
	...
	Ожидается.Тест("Статус после удаления").Что(ВК).Функц("status").Результат().Получить("work").Функц("Получить", 0).Получить("new_name").Равно(ИмяФайла);
