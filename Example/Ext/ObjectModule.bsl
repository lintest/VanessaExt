...
Процедура Тест_ЗапускПриложений(Ожидается) Экспорт
	...
	Ожидается.Тест("Эмуляция горячей клавиши").Что(ВК).Проц("Пауза", 100).Проц("ЭмуляцияНажатияКлавиши", "[17, 83]");
	Ожидается.Тест("Эмуляция ввода текста").Что(ВК).Проц("Пауза", 100).Проц("ЭмуляцияВводаТекста", ПутьФайла, 50);
	Ожидается.Тест("Запись тестового файла").Что(ВК).Проц("Пауза", 100).Проц("ЭмуляцияНажатияКлавиши", "[13]");
	Ожидается.Тест("Запись тестового файла").Что(ВК).Проц("Пауза", 100).Проц("ЭмуляцияНажатияКлавиши", "[18, 115]").Проц("Пауза", 100);
