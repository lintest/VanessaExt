...
powershell Compress-Archive -LiteralPath .\bin\lib1cWinCtrlLin32.so -DestinationPath ./AddIn.zip -Update
powershell Compress-Archive -LiteralPath .\bin\lib1cWinCtrlLin64.so -DestinationPath ./AddIn.zip -Update
powershell Compress-Archive -LiteralPath .\bin32\lib1cWinCtrlWin32.dll -DestinationPath ./AddIn.zip -Update
powershell Compress-Archive -LiteralPath .\bin64\lib1cWinCtrlWin64.dll -DestinationPath ./AddIn.zip -Update
